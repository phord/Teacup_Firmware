...
// #define LOOKAHEAD_MAX_JERK_XY 25     // Resulted in X slips on Spool_Roller_repaired
// #define LOOKAHEAD_MAX_JERK_XY 10     // Occasional Y-slips
#define LOOKAHEAD_MAX_JERK_XY 5
