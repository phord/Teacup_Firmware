...
/* The following enum gives numeric values to each of the pin names which would
    normally be defined in the chip-specific include file.  All of the pins Teacup
    uses are listed here even though not all of them may be defined in the config.
