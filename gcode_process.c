  ...
  if (next_target.seen_G) {
    ...
    switch (next_target.G) {
      ...
      case 2:
        //? --- G2: Arc Clockwise ---
        //?
        //? Example: G2 I-3 J-2 X90.6 Y13.8 E22.4
        //?
        //? Go in a circular arc clockwise around a center at (X-3, Y-2) from the current
        //? (X, Y) point to the point (90.6, 13.8), extruding material as the
        //? move happens from the current extruded length to a length of 22.4 mm.
        //?
        adjust_arc_coords(0);
        temp_wait();
        enqueue(&next_target.target);
      ...
      case 3:
        ...
        //?
        //? Example: G3 I-3 J-2 X90.6 Y13.8 E22.4
        //?
        //? Go in a circular arc counter-clockwise around a center at (X-3, Y-2) from the current
        //? (X, Y) point to the point (90.6, 13.8), extruding material as the
        //? move happens from the current extruded length to a length of 22.4 mm.
        //?
        adjust_arc_coords(1);
